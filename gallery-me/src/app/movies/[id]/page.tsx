...
export default function MovieDetails({ params: { id } }: MovieDetailsProps) {
	...
	return (
		<div className="relative h-full px-2 py-4 mx-auto overflow-y-auto max-w-7xl sm:px-6 lg:px-8 bg-nightblue">
			{!movie
				? (
					<div className="h-screen text-center border-2 rounded-lg border-slate-300">
						<p className="mt-16 text-center">Loading...</p>
					</div>
				)
				: (
					<div className="flex flex-col gap-4 lg:grid lg:grid-flow-row-dense lg:grid-cols-3">
